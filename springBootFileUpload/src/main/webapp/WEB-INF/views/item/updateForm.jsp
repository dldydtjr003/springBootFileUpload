...
<body>
	...
	<div class="write-container">
		...
		<form action="/item/update" method="post"
			...
			<div class="form-group">
				<label for="picture1">상품 이미지</label> 
				<img alt="상품이미지" src="/item/display?id=${item.id}" width ="400" id="picture1" />
			</div>
			...
			<div class="btn-area">
				<a href="/item/itemList" class="btn btn-submit">상품 목록</a>
				<button type="submit" class="btn btn-submit">상품수정 등록</button>
				<button type="reset" class="btn btn-submit">상품 수정 취소</button>
			</div>
		</form>
